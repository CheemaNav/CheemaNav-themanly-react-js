...
<p><i className=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
...
Punjab 160071</p>
<ul class="nav  justify-content-start list-unstyled d-flex mb-4 social_icon">
      <li class="ms-3"><a class="text-white" href="https://www.instagram.com/themanly.in" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
...
<li class="ms-3"><a class="text-white" href="https://www.facebook.com/profile.php?id=61561176876540" target='_blank'>
...
<li class="ms-3"><a class="text-white" href="https://www.youtube.com/@themanlydotin" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-youtube" viewBox="0 0 16 16">
...
<li class="ms-3"><a class="text-white" href="https://x.com/Themanlydotin" target='_blank'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
  <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
</svg></a></li>
<li class="ms-3"><a class="text-white" href="https://www.linkedin.com/showcase/themanly-in/?viewAsMember=true" target='_blank'>
